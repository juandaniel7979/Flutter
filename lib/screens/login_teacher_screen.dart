...
class _LoginPageState extends State<LoginPageTeacher> {
  ...
  Future _login() async {
    ...
    final response = await http.post(
        Uri.http("192.168.56.1", "/PPI_ANDROID/user/login_teacher.php"), body:json.encode(data));
    ...
    if(datauser.length==0){
      ...
      Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => HomeScreen(id:datauser[0]['id_profesor'],email : emailController.text,name: datauser[0]['nombre']+' '+datauser[0]['nombre_2']+' '+datauser[0]['apellido']+' '+datauser[0]['apellido_2']))
      );
